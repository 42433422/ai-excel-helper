...
echo [1/2] Starting backend at http://127.0.0.1:5000 (DISABLE MODS) ...
start "XCAGI Backend (Basic)" /D "%~dp0" cmd /k "set XCAGI_DISABLE_MODS=1 && ""%PYTHON_EXE%"" run.py"
